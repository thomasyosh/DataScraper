...
drop table if exists search_result_all_chi;

create table search_result_all_chi as
select 
	am.id as AddressID, 
...
create index idx_AddressID_ranking_number on search_result_all_chi(AddressID, ranking_number);
...
where
	search_result_all_chi.AddressID = ase.id and search_result_all_chi.ranking_number = ase.Address_Search_Ranking;
...
where
	search_result_all_chi.AddressID = gm.id and search_result_all_chi.ranking_number = gm.Geodata_Ranking;
...
where
	search_result_all_chi.AddressID = ogcio.id and search_result_all_chi.ranking_number = ogcio.Ogcio_Ranking;
